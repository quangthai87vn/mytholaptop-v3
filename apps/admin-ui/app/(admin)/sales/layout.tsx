/**
 * Layout guard for /sales/*
 *
 * Requires sales.read permission.
...
export default async function SalesLayout({
  ...
  if (!sessionId) redirect("/login?redirect=/sales");
  ...
  if (!hasPermission(user, "sales.read")) {
    redirect("/403?message=Bạn không có quyền truy cập Bán hàng");
  }
