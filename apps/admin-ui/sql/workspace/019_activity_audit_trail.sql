-- ============================================================
-- Migration: 019_activity_audit_trail.sql
-- P6.8: Activity Log Enhancement & Audit Trail
-- Mục tiêu: Nâng cấp v_workspace_activities gom đầy đủ nguồn log
-- Run: node scripts/run-migration-019.js
-- ============================================================
BEGIN;
...
-- GRANT SELECT ON pm_notification_events TO mytholaptop_user;
-- GRANT EXECUTE ON FUNCTION notify_user TO mytholaptop_user;
