...
$env:STORE_CORS = "http://localhost:8000,http://localhost:7004,https://admin.mtl.vn"
$env:ADMIN_CORS = "https://admin.mtl.vn,https://backend.mtl.vn"
$env:AUTH_CORS = "https://admin.mtl.vn,https://backend.mtl.vn"
